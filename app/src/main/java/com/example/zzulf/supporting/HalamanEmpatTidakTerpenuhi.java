...
public class HalamanEmpatTidakTerpenuhi extends AppCompatActivity {
    Button btnOption1, btnOption2, btnOption3;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_halaman_empat_tidak_terpenuhi);
        ...
        btnOption1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(HalamanEmpatTidakTerpenuhi.this,Output.class);
